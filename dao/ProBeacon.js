...
const getAllAreadetailBylatlng = function (minlat, maxlat, minlng, maxlng) {
    let sql = "select * from beaconsever.arealist where area_lat >= " + minlat + " and area_lat <= " + maxlat + "and area_lng >= " + minlng + " and area_lng <=" + maxlng + ";"
    return pros(sql);
}
